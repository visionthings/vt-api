...
">
    ...
    <tr>
        <td style="padding-right: 20px; padding-left:20px">
            ...
            <p>لقد أضفت {{ $user['email'] }} مؤخراً إلى حسابك على موقع رؤية الأشياء.</p>
            <p> يرجى تأكيد عنوان البريد الإلكتروني هذا حتى يمكنك الإستفادة من جميع خدماتنا.</p>

            <div style="padding-top:40px">
                <a href={{ $url }} style="cursor:pointer">
                    <button
                        style="border:none; background-color:darkcyan; color:white; padding: 10px 40px; border-radius:7px; cursor:pointer">اضغط
                        هنا لتأكيد البريد الإلكتروني</button>
                </a>
            </div>

            <p style="color:slategray; padding-top:40px">للمساعدة في الحفاظ على أمان حسابك، يرجى عدم إعادة توجيه رسالة
